...
ORIGINAL_FFT = 256
ORIGINAL_WINDOW_LENGTH = 2
ORIGINAL_SAMPLE_RATE = 22050

MAGIC_NUMBER = ORIGINAL_SAMPLE_RATE * ORIGINAL_WINDOW_LENGTH - ORIGINAL_FFT

QUALITY_FACTOR = 4

FFT_HOP = ORIGINAL_FFT // QUALITY_FACTOR
AUDIO_WINDOW_LENGTH = ORIGINAL_WINDOW_LENGTH * QUALITY_FACTOR
AUDIO_SAMPLE_RATE = (MAGIC_NUMBER + FFT_HOP) // AUDIO_WINDOW_LENGTH
